...
def stats():
    ...
    global sum_1a, sum_2a, sum_1b, sum_2b, sum_3a, sum_3b, sum_4a, sum_4b, sum_4c, sum_5a, sum_5b, sum_5c, \
    ...
    return render_template("stats.html", title="Статитстика", sum_1a=sum_1a, sum_2a=sum_2a, sum_1b=sum_1b, sum_2b=sum_2b,
                           sum_3a=sum_3a, sum_3b=sum_3b, sum_4a=sum_4a, sum_4b=sum_4b, sum_4c=sum_4c,
...
@app.route("/post1b", methods=["GET", "POST"]) # Адрес страницы для отправки данных по 1А классу
@login_required
def post1b():
    """
    ...
    """
    grade = "1Б"
    form = forms.pupil.Post1B() # Форма для отправки данных по 1Б классу
    if form.validate_on_submit() and current_user.is_authenticated: # Если нажата кнопка "Отправить" и при этом пользователь аутентифицирован
        db_sess = db_session.create_session() # Созадть сессию с БД
...
def main():
    ...
    for j in ["1А", "1Б", "2А", "2Б", "3А", "3Б", "4А", "4Б", "4В", "5А", "5Б", "5В", "6А", "6Б", "6В", # Перебор классов
              "7А", "7Б", "7В", "8А", "8Б", "8В", "9А", "9Б", "9В", "10А", "10Б", "10В", "11А", "11Б", "11В"]:
        for i in open(f"db/Grades/{j}.txt", encoding="utf-8").readlines(): # Перебор ФИ в файле
